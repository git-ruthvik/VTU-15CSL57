...
public class Crc16 {
  ...
  public static void main(String[] args) {
      ...
      int remainder = 0x00000; // Initial value of CRC.

      int polynomial = 0x11021; // ideally it is 0x11021
    ...
    System.out.println("CRC16 value of input data " + args[0] + " is " + Integer.toHexString(remainder));
  }
